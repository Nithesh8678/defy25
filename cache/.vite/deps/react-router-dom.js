import {
  require_react_dom
} from "./chunk-2JCOJD2O.js";
import {
  require_react
} from "./chunk-X7GY54F7.js";
import {
  __commonJS,
  __publicField,
  __toESM
...
function normalizeNavigateOptions(isFetcher, path, opts) {
  ...
  if (opts.body !== void 0) {
    if (opts.formEncType === "text/plain") {
      ...
      let text = typeof opts.body === "string" ? opts.body : opts.body instanceof FormData || opts.body instanceof URLSearchParams ? Array.from(opts.body.entries()).reduce(
...
function useBlocker(shouldBlock) {
  let { router: router2, basename } = useDataRouterContext("useBlocker");
...
function useNavigateStable() {
  let { router: router2 } = useDataRouterContext("useNavigate");
...
function PrefetchPageLinksImpl({
  ...
  return React9.createElement(React9.Fragment, null, dataHrefs.map((href) => React9.createElement("link", { key: href, rel: "prefetch", as: "fetch", href, ...linkProps })), moduleHrefs.map((href) => React9.createElement("link", { key: href, rel: "modulepreload", href, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => React9.createElement("link", { key, ...link })));
}
function Meta() {
...
${matches.map(
  ...
  ${enableFogOfWar ? `window.__reactRouterManifest = ${JSON.stringify(
...
var Link = React10.forwardRef(
  function LinkWithRef({
    ...
    let link = React10.createElement(
      "a",
      {
        ...rest,
        ...prefetchHandlers,
...
function useSubmit() {
  let { router: router2 } = useDataRouterContext3("useSubmit");
  let { basename } = React10.useContext(NavigationContext);
...
function useFetcher({
  ...
  let { router: router2 } = useDataRouterContext3("useFetcher");
...
function useScrollRestoration({
  ...
  let { router: router2 } = useDataRouterContext3("useScrollRestoration");
...
function HydratedRouter() {
  ...
  return React22.createElement(React22.Fragment, null, React22.createElement(
    FrameworkContext.Provider,
    {
      value: {
